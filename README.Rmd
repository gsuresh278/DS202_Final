...
countries with the highest emissions. Along with that, we showed comparisons
of CO2 emissions over time and the difference in emissions between developed
...
representing the years of key international agreements. The Kyoto Protocol,
created in 1997, and the Paris Agreement, enacted in 2015, are two
of the most influential climate agreements to date, so we chose to use
those as our markers.
